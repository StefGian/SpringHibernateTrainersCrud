...
public class TrainerDaoImpl extends AbstractDao<Integer, Trainer> implements TrainerDao { //Integer -> primary key tou entity Trainer

	public Trainer findById(int id) {
		return getByKey(id);
	}

	public void saveTrainer(Trainer employee) {
		persist(employee);
	}
